              ...
              <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <form action="get_ex_gratia_sample" method="POST">
                          {{ csrf_field() }}
                          <div class="body">
                          <div class="row clearfix">
                               <div class="col-sm-3">
          					...
          					<form action="upload_ex_gratia_csv" id="form" method="POST" enctype="multipart/form-data">
          					{{ csrf_field() }}
					<!--body Start-->	
                        <div class="body">
                            ...
                            <div class="row clearfix">
                              <div class="col-sm-2" align="right">
                                ...
                                <div class="form-line">
                                  ...
                                  <!-- @if(Session::has('upload_ex_gratia'))
                                  @if(Session::get('upload_ex_gratia')=='pending')
