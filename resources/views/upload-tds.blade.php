              ...
              <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <form action="get_tds_sample" method="POST">
                          {{ csrf_field() }}
                          <div class="body">
                          <div class="row clearfix">
                             <div class="col-sm-3">
                              ...
                              <div class="col-sm-1"> 
                                <button type="submit" name="button" class="btn bg-green waves-effect">Download Sample </button>
                              </div>
                          </div>
                        </div>
                    </form>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-2" align="right">
                                 ...
                                 <div class="col-sm-4">
                                  ...
                                  <!-- @if(Session::has('upload_tds'))
                                  @if(Session::get('upload_tds')=='pending')
