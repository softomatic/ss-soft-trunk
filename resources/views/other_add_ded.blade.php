...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>Other Addition/Deduction</h2>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
	                        ...
	                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                           <div class="table-responsive" id="other_add_ded_table">
...
$(document).ready(function() {
    ...
    $('#create').click(function(){
    	...
    	{    		
    		...
    		$.ajax({
	            ...
	            success:function(data){ 
	                $('#other_add_ded_table').empty().html(data);
	            }
            });
    	}
    	else
    	{
    		...
    		$('#other_add_ded_table').empty().html('');
    	}
    });
